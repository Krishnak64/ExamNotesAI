    ...
    text-white'>
        ...
        disabled={loading}
            ...
            ${
               ...
               : "bg-gradient-to-br from-white to-gray-200 text-black shadow-[0_5px_15px_rgba(0,0,0,0.4)]"
            }
            `}>
...
function Toggle({label, checked, onChange}){
    return (
        <div className='flex items-center gap-4 cursore-pointer select-none' onClick={onChange}>
            <motion.div
            animate={{
                backgroundColor: checked
                ? "rgba(34,197,94,0.34"  // green when on
            ...
            border border-white/20
            backdrop-blur-lg'>
                <motion.div className='absolute top-0.5
