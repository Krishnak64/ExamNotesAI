  ...
  return (
    <div  className='min-h-screen bg-gray-100 px-6 py-10 relative'>
      ...
      <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 '>
        ...
        amount={500}
        credits="500 Credits"
        description="For serious exam preperation"
        features={[
  ...
  return (
    ...
    ${isSelected
      ...
      `}>
        ...
        {popular && !isSelected && <span className='absolute top-4 right-4 text-xs px-2 py-1 
        rounded bg-indigo-600 
        text-white'>Popular</span>}

        {isSelected && <span className='absolute top-4 right-4 text-xs px-2 py-1 rounded bg-black
        text-white'>
          Selected
        </span>}
        ...
        `}>
         {isPlayingThisCard ? "Redirecting...": "Buy Now"}
        </button>
