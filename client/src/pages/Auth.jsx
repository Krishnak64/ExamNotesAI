...
function Auth() {
  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
        ...
        <main className='max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-cneter'>
           
           {/* ------ Left Contenet of Home page ------ */}
           <motion.div
           ...
           >
              ...
              leading-tight bg-gradient-to-br from-black/90 via-black/60 to-black/90 
           ...
           {/* ------ Right Contenet of Home page ------ */}
           <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
              <Feature icon="🎁" title="100 Free Credits" des="Start with 100 free credits to generate notes without paying"/> 
              <Feature icon="📓" title="Exam Notes" des="High-yield, revision-ready exam-oriented notes"/> 
              <Feature icon="📂" title="Project Credits" des="Well-structured documentation for assignments & projects."/> 
              <Feature icon="📊" title="Charts & Graphs" des="SAuto-generated diagrams, charts and flow graphs."/> 
