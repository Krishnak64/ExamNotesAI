...
function History() {
  ...
  const [selectNote, setSelectedNode] = useState(null)
...
console.log(res)
    setSelectedNode(res.data.content)
    setLoading(false)
  } catch (error) {
    console.log(error)
    setLoading(false)
    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      ...
      shadow-[0_20px_45px_rgba(0,0,0,0.6)]'>
        ...
        <div onClick={()=> navigate("/")} className='cursor-pointer'>
            ...
            to-white bg-clip-text text-transparent'>ExamNotes AI</h1>
          ...
          <div className='flex items-center gap-4 flex-wrap'>
            ...
            className='lg:hidden text-white text-2xl'><GiHamburgerMenu /></button>}
            ...
            text-white text-sm' onClick={()=>navigate("/pricing")}>
              ...
              whileTap={{scale:0.97}} 
              className='ml-2 h-5 w-5 flex items-center justify-center rounded-full bg-white  
              text-xs font-bold'
              >
                ➕
            ...
            {isSidebarOpen &&
              ...
              overflow-y-auto'>
                  ...
                  <div className='mb-4 space-y-1'>
                    <button onClick={()=>navigate("/notes")} className='w-full px-3 py-2 rounded-lg text-sm text-gray-200 bg-white/10
                   hover:bg-white/20 text-start'>
                    ...
                    <ul className='space-y-3'>
                      ...
                      {topics.map((t,i)=>(
                        <li key={i} onClick={()=>{openNotes(t._id)}} className={`cursor-pointer rounded-xl p-3 border
                        ...
                        `}>
                          ...
                          <div className='flex flex-wrap gap-2 mt-2 text-xs'>
                              {t.classLevel && <span className='px-2 py-0.2 rounded-full bg-indigo-500/20
                              text-indigo-300'>ClassLevel : {t.classLevel}</span>}

                              {t.examType && <span className='px-2 py-0.2 rounded-full bg-purple-500/20
                          ...
                          <div className='flex gap-3 mt-2 text-xs text-gray-300'>
                            ...
                            {t.revisionChart && <span>📈 Chart</span>}
                          </div>
