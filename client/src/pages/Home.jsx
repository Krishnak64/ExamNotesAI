    ...
    <div className=' min-h-screen overflow-hidden bg-white text-black'>
        ...
        <div>
          ...
          >
            ...
            >
              ...
              flow diagrams and rebision-ready content using AI - 
     ...
     //       transition={{type: "spring", stiffness: 200, damping: 18}}
      ...
      md:grid-cols-4 gap-10'>
        ...
        <Feature icon="📂" title="Project Notes" des="Well-structured content for assignment
        and projects."/>
        <Feature icon="📊" title="Diagrams" des="Auto-generated visual diagrams for clarity."/>
        <Feature icon="⬇️" title="PDF Download" des="Download clean, printable PDFs
        instantly."/>
